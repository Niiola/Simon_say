...
class SimonSays:
    def __init__(self):
        ...
        self.main_colours = [DARKYELLOW, DARKBLUE, DARKRED, DARKGREEN]
    ...
    def update(self):
        if not self.waiting_input:
            ...
            self.pattern.append(random.choice(self.main_colours))
    ...
    def button_animation(self, colour):
        for i in range(len(self.main_colours)):
            if self.main_colours[i] == colour:
                sound = self.beeps[i]
